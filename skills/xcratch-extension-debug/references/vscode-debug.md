...
>
> Chrome may also show a **Local Network Access** permission prompt ("Access other apps and services on this device") because the public editor fetches from the loopback `0.0.0.0:5500` — click
> **Allow**, then reload so the extension is fetched. (For fully automated playwright-cli
